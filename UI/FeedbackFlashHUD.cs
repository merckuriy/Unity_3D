...
public class FeedbackFlashHUD : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (m_timeManager.TimeRemaining < showCriticalTimeVignetteWhen && !m_GameFlowManager.isGameEnded)
        {
            EnableFlash(true);
        ...
        else if (m_timeManager.TimeRemaining > showCriticalTimeVignetteWhen || m_GameFlowManager.isGameEnded)
        {
            EnableFlash(false);
        }
